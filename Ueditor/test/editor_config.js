...
//        'tablesuper': '表格高级设置',
    ...
    iframeUrlMap: {
        'anchor': '/PHP/cippus/Ueditor/dialogs/anchor/anchor.html',
        'image': '/PHP/cippus/Ueditor/dialogs/image/image.html',
        'inserttable': '/PHP/cippus/Ueditor/dialogs/table/table.html',
        'link': '/PHP/cippus/Ueditor/dialogs/link/link.html',
        'emoticon': '/PHP/cippus/Ueditor/dialogs/emoticon/emoticon.html',
        'spechars': '/PHP/cippus/Ueditor/dialogs/spechars/spechars.html',
        'searchreplace': '/PHP/cippus/Ueditor/dialogs/searchreplace/searchreplace.html',
        'map': '/PHP/cippus/Ueditor/dialogs/map/map.html',
        'gmap': '/PHP/cippus/Ueditor/dialogs/gmap/gmap.html',
        'video': '/PHP/cippus/Ueditor/dialogs/video/video.html',
        'help': '/PHP/cippus/Ueditor/dialogs/help/help.html',
        'code' : '/PHP/cippus/Ueditor/dialogs/code/code.html',
        'multimenu': '/PHP/cippus/Ueditor/dialogs/menu-emoticon/emoticon.html',
        'insertframe': '/PHP/cippus/Ueditor/dialogs/insertframe/insertframe.html'
    },
    listMap: {
    ...
    initialContent: '<span style="color:#ccc">CIPPUS~~</span>',  //初始化编辑器的内容
