...
//        'tablesuper': '表格高级设置',
    ...
    iframeUrlMap: {
        'anchor': '/cippus/Ueditor/dialogs/anchor/anchor.html',
        'image': '/cippus/Ueditor/dialogs/image/image.html',
        'inserttable': '/cippus/Ueditor/dialogs/table/table.html',
        'link': '/cippus/Ueditor/dialogs/link/link.html',
        'emoticon': '/cippus/Ueditor/dialogs/emoticon/emoticon.html',
        'spechars': '/cippus/Ueditor/dialogs/spechars/spechars.html',
        'searchreplace': '/cippus/Ueditor/dialogs/searchreplace/searchreplace.html',
        'map': '/cippus/Ueditor/dialogs/map/map.html',
        'gmap': '/cippus/Ueditor/dialogs/gmap/gmap.html',
        'video': '/cippus/Ueditor/dialogs/video/video.html',
        'help': '/cippus/Ueditor/dialogs/help/help.html',
        'code' : '/cippus/Ueditor/dialogs/code/code.html',
        'multimenu': '/cippus/Ueditor/dialogs/menu-emoticon/emoticon.html',
        'insertframe': '/cippus/Ueditor/dialogs/insertframe/insertframe.html'
    },
    listMap: {
